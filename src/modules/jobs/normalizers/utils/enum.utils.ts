 ...
 */
const ENUM_VALUE_CACHE = new WeakMap<EnumLike, ReadonlySet<string>>();
 ...
 */
function getEnumValueSet(enumObject: EnumLike): ReadonlySet<string> {
 ...
 */
const ENUM_VALUES_CACHE = new WeakMap<EnumLike, readonly string[]>();
